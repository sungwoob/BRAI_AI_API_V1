...
**요청 예시**:
```bash
curl -X GET "https://api.brai.example.com/api/dataset"
```
...
**요청 예시**:
```bash
curl -X GET "https://api.brai.example.com/api/dataset/{dataset_id}"
```
...
**요청 예시**:
```bash
curl -X GET "https://api.brai.example.com/api/strains/{strain_id}"
```
...
**요청 예시**:
```bash
curl -X GET "https://api.brai.example.com/api/models"
```
