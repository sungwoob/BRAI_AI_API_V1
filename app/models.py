...
class PredictedPhenotype(BaseModel):
    weight: PhenotypePrediction
    length: PhenotypePrediction
    sugarContent: PhenotypePrediction
    firmness: PhenotypePrediction
    shape: PhenotypePrediction
